...
class NeighborInterpolation(Function):
    ...
    def forward(ctx, points_coords, centers_coords, centers_features):
        ...
        points_features, indices, weights = _ext.three_nearest_neighbors_interpolate_forward(
    ...
    def backward(ctx, grad_output):
        ...
        grad_centers_features = _ext.three_nearest_neighbors_interpolate_backward(
