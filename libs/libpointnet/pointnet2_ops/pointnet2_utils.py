...
try:
    ...
    logging.info("Unable to load PointNet++ CUDA kernels. JIT compiling.")
    logging.info("Consider installing the CUDA kernels with `python libs/libmanager.py install pointnet`.")
    ...
    try:
        ...
        logging.error("Unable to JIT compile PointNet++ CUDA kernels.")
