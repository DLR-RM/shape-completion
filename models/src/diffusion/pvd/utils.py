...
from .modules import PointNetAModule, PointNetFPModule, PointNetSAModule, PVConv, SharedMLP, Swish
...
def create_pointnet2_sa_components(
    ...
    for conv_configs, sa_configs in sa_blocks:
        ...
        if num_centers is None:
            ...
            block = partial(PointNetSAModule, num_centers=num_centers, radius=radius, num_neighbors=num_neighbors)
        sa_blocks.append(
            block(
